angular.module("altairApp").controller("mainCtrl", ["$scope", "$rootScope",
    function($scope, $rootScope) {}
]).controller("main_headerCtrl", ["$timeout", "$scope", "$window", "$state",
    function($timeout, $scope, $window, $state) {
        ...
        }, $scope.alerts_length = $scope.user_data.alerts.length, $scope.messages_length = $scope.user_data.messages.length, $("#menu_top").children("[data-uk-dropdown]").on("show.uk.dropdown", function() {
            $timeout(function() {
                $($window).resize()
            }, 280)
...
]).controller("main_sidebarCtrl", ["$timeout", "$scope", "$rootScope",
            ...
            $timeout(function() {
                if ($rootScope.miniSidebarActive) {
                    ...
                    tooltip_elem.each(function() {
                        var $this = $(this);
                        $this.attr("title", $this.find(".menu_title").text()), UIkit.tooltip($this, {
                            pos: "right"
                        })
                    })
                } else $("#sidebar_main").find(".current_section > a").trigger("click")
            })
        ...
        $scope.langSwitcherConfig = {
            ...
            render: {
                option: function(langData, escape) {
                    return '<div class="option"><i class="item-icon flag-' + escape(langData.value).toUpperCase() + '"></i><span>' + escape(langData.title) + "</span></div>"
                },
            ...
            onInitialize: function(selectize) {
                $("#lang_switcher").next().children(".selectize-input").find("input").attr("readonly", !0)
            }
        }, $scope.sections = [{
            id: 0,
            title: "Dashboard",
